...
import AcceptPartner from "../../../components/AcceptPartner";
import RefusePartner from "../../../components/RefusePartner";


export default function ItemPedingApproval({ user, onAccepted }: any) {
    const { sportsMap, loading } = useManagedAreas(user.id);
                ...
                <div className="m-0 p-0">
                    ...
                    <div className="m-0 p-3 py-2 rounded-top-4 bg-header text-light d-flex justify-content-between px-3 align-items-center">
                        ...
                        <div className="text-end">
                            <AcceptPartner user={user} sport={sportsArray} onAccepted={onAccepted} />
                            <RefusePartner user={user} onAccepted={onAccepted} />
                        </div>
                    </div>
